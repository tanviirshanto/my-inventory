...
export default function StockEntryGrouped() {
  ...
  const loadEntries = async () => {
    setLoading(true);
    try {
      const data = await fetchStockEntryGroups({ fromDate, toDate });
      setEntries(data);
    } catch {
  ...
  return (
    <div className="max-w-full p-4 border rounded shadow">
      ...
      <div className="flex flex-wrap items-end  gap-4 mb-4">
        ...
        <Button onClick={loadEntries}>Filter</Button>
